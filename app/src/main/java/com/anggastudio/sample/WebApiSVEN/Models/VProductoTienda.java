...
public class VProductoTienda {
    ...
    public VProductoTienda(String articuloID, String articuloDS, Double cantidad, Double soles, Double descuento, Double incremento) {
